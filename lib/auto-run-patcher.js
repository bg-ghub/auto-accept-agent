...
const ALL_MARKERS = [PATCH_MARKER, FILEACCESS_MARKER, AUTOEXPAND_MARKER];
...
/** Strip all patches (autorun, fileaccess, autoexpand) */
function stripMarkers(content) {
    return stripAutoexpandPatch(stripAutorunPatch(stripFileaccessPatch(content)));
}
